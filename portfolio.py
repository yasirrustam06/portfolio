...
side_h1 = """
    <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>Computer Vision and NLP Enthusiast </h1>
    """

st.markdown(side_h1, unsafe_allow_html=True)
image = Image.open('my_dp.png')
st.image(image, width=150)
my_name = "<h5 style = 'font-size:30px; align-items: center ; padding-top:0rem; color:#000000;'>YASIR ALI</h5>"
st.markdown(my_name, unsafe_allow_html=True)

about_me = """"
      <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>About Me </h1>
"""
...
#####################
edu_head = """
            <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>Education</h1>
...
work_exp_head = """ 
                    <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>Work Experience</h1>
...
#####################
Project_Head = """ 
                    <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>Projects</h1>
...
#####################
pakages_heading = """ 
                    <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000;'>My Experienced Python Packages</h1>
...
social_media_heading = """
        <h1 style='font-size:36px;font-weight:bold;border-radius:10px;color:#000000; align-items: center'>Social Media</h1>"""
